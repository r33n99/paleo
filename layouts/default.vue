      ...
      <v-card color="transparent" class="page-wrapper pt-120 pb-16" rounded="0" elevation="0">
        <v-card-text class="pa-0 px-16 mx-8 d-flex flex-column">
          <div class="d-flex justify-space-between align-center">
            ...
            <div>
              <span style="color: #ECEEEC" class="font-weight-300 text-20">
                <NuxtLink :to="{ path: '/', hash: '#projects' }"
                  class="cursor-pointer nav-item text-decoration-none text-white-second">Проекты</NuxtLink><span
                  style="color: #3C403C" class="font-weight-400 mx-5">/</span>
                <NuxtLink :to="{ path: '/', hash: '#info' }"
                  class="cursor-pointer nav-item text-decoration-none text-white-second">Кто мы такие</NuxtLink><span
                  style="color: #3C403C" class="font-weight-400 mx-5">/</span>
                <NuxtLink :to="{ path: '/', hash: '#services' }"
                  class="cursor-pointer nav-item text-decoration-none text-white-second">Услуги</NuxtLink>
                <span style="color: #3C403C" class="font-weight-400 mx-5">/</span>
                <NuxtLink :to="{ path: '/', hash: '#contacts' }"
                  class="cursor-pointer nav-item text-decoration-none text-white-second">Контакты</NuxtLink>
              </span>
            </div>
          </div>
          <div class="d-flex align-center justify-space-between">
            ...
            <div class="d-flex justify-end mt-11">
              <NuxtLink class="ma-0 pa-0 mt-1" @click="scrollToAnchor('top')">
                <div class="arrow">
                  <img width="32px" height="32px" src="/static/images/arrowTop.svg" alt="arrowTop">
                </div>
              </NuxtLink>
            </div>
          </div>
      ...
      <v-card color="transparent" class="page-wrapper pt-80 pb-12" rounded="0" elevation="0">
        <v-card-text class="pa-0 px-5 d-flex flex-column">
            ...
            <div class="d-flex justify-space-between">
              ...
              <NuxtLink class="ma-0 pa-0 mt-1" @click="scrollToAnchor('top')">
                <div class="arrow_mobile">
                  <img width="24px" height="24px" src="/static/images/arrowTop.svg" alt="arrowTop">
                </div>
              </NuxtLink>
            </div>
          ...
          <div class="mt-8 d-flex flex-column">
            <div>
              <img width="70" src="/static/images/logo.svg" alt="logo">
            </div>
            <div class="d-flex flex-column mt-5">
              <span class="text-14 font-text opacity-70 text-white mb-4">© 2024. Все права защищены</span>
              <span class="text-14 font-text opacity-70 text-white text-decoration-underline">Политика
                конфидециальности</span>
            </div>
          </div>
        </v-card-text>
      </v-card>
